...
Mar 16 target for the first prod release is missed. We submitted the PRs on schedule, but QA found a +24% prediction deviation in staging vs +4% on production. Root cause: model prediction win rates produce worse results than historical.
